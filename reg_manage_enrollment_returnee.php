                  ...
                  <div class="ibox-content">
                    ...
                    <div class = "container">
                      ...
                      <div id = "student_info">
                       ...
                       <div class="row mt-4">
                        <div class="col-sm" >                     
                          <button type="button" class="btn btn-success btn-sm border-secondary" id="next_btn" style = "float:right;">Next</button>
                        </div> 
                      </div>
  ...
  $(document).ready(function(){
    $('#next_btn').click(function(){
      ...
      if (student_id == ""
          ...
          window.location = "subjects_credited_returnee.php?faculty_user_id="+faculty_user_id+"&student_id="+student_id+"&academic_id="+academic_id+"&department_id="+department_id+"&program_id="+program_id+"&curriculum_id="+curriculum_id+"&student_status="+student_status+"&student_year_level="+student_year_level+"&student_semester="+student_semester+"&student_section="+student_section;	
        }
  ...
  $(document).ready(function(){
    $('#student_id').keyup(function(){
      ...
      var student_id = $(this).val();
        ...
        $.ajax({
          url:"admin_classes/get_info_returnee.php",
          method:"POST",
