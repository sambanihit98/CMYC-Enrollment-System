      ...
      <div class="wrapper wrapper-content bg-white ">
        ...
        <div class="row">
          ...
          <div class="ibox-content text-dark">
            ...
            <h4 class="text-center"><strong>Welcome, <?php echo "$account_firstname";  ?> to your personal page!</strong></h4><br><br>
        ...
        $.ajax({
            ...
            success: function(dataResult){
              ...
              if(dataResult.statusCode==200){
                window.location = "registrar_dashboard.php?password_changed"						 
