                    ...
                    <div class = "row">
                      <div class = "col-md-6">
                        ...
                        <div class = "row" >
                          ...
                          <div class = "col-sm-8">
                            <p style = 'font-weight: bold; font-size: 15px; vertical-align: middle;'>New Student</p>
                          </div>
                        </div>
    ...
    $('#save_btn').click(function(){
      ...
      var email              = $('#email').val();
        ...
        if (department_id == "" 
          ...
          $.ajax({
            url: "admin_classes/insert_new_student_enrollment.php",
            type: "POST",
            data: {
            ...
            success: function(dataResult){
              var dataResult = JSON.parse(dataResult);
                if(dataResult.statusCode==200){
                    window.location = "registrar_manage_enrollment.php?new_student_added";	
