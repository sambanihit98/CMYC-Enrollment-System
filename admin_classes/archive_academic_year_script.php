...
if(isset($_POST['academic_id'])){
  ...
  $user_action = 'Archived academic year <b>'.$academic_year_from.' - '.$academic_year_to.' '.'('.$academic_term.')</b>';
  ...
  $zero          = 0;
    ...
    mysqli_query($con, "UPDATE academic_year SET academic_status = 2 WHERE academic_id = '$academic_id'");

    header("location:../admin_academic.php?archived&academic_id=$academic_id");
}
