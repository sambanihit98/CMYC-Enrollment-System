...
if(isset($_POST['save_btn'])){
  ...
  $zero             = 0;  
  $user_action      = 'Enrolled <b>'.$fullname.' (Transferee)</b> in <b>'.$section.'</b> for the academic year <b>'.$academic_year.'</b>';
  ...
  if (mysqli_num_rows($query1)>0){
    header("location:../reg_manage_enrollment_transferee.php?already_enrolled");

  }else if(mysqli_num_rows($query2)>0){
    header("location:../reg_manage_enrollment_transferee.php?duplicate");
    ...
    foreach($checkbox_value as $subject_id){
      ...
      //inserts on grades report table
  ...
  header("location:../registrar_manage_enrollment.php?transferee_added");
}
