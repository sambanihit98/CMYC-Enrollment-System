...
if(isset($_POST['account_user_id'])){
    ...
    $user_action   = 'Deactivated <b>'.$fullname.' '.'('.$account_position.')</b>'.' account';
    ...
    mysqli_query($con, "INSERT INTO `user_log`(`user_log_id`, `account_user_id`, `user_action`, `user_log_time`, `user_log_date`) 
        ...
        mysqli_query($con, "UPDATE faculty_account SET account_status = 0 WHERE account_user_id = '$account_user_id'");

        header("location:../admin_designation.php?deactivated&name=$fullname");
