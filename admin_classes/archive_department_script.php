...
if(isset($_POST['department_id'])){
    ...
    $user_action      = 'Archived <b>'.$department_description.' '.'('.$department_code.')</b>'.' department';
    ...
    mysqli_query($con, "UPDATE manage_department SET department_status = 2 WHERE department_id = '$department_id'");

    header("location:../registrar_manage_department.php?archived&department_id=$department_id");
}
