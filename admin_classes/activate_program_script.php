...
if(isset($_POST['program_id'])){
    ...
    $user_action      = 'Activated <b>'.$program_description.' '.'('.$program_code.')</b> program';
    ...
    while($row = mysqli_fetch_array($query)){
        ...
        header("location:../registrar_manage_program.php?department&department_id=$department_id&program_id=$program_id&activated");
    }
}
