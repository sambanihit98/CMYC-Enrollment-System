...
if(isset($_POST['curriculum_id'])){
    ...
    $user_action      = 'Deactivated <b>'.$curriculum.'</b> curriculum';
    ...
    while($row = mysqli_fetch_array($query)){
        ...
        header("location:../registrar_manage_curriculum.php?department&department_id=$department_id&curriculum=$curriculum&deactivated");
    }
