...
if(isset($_POST['program_id'])){
    ...
    $user_action      = 'Deactivated <b>'.$program_description.' '.'('.$program_code.')</b> program';
    ...
    while($row = mysqli_fetch_array($query)){
        ...
        mysqli_query($con, "UPDATE manage_program SET program_status = 0 WHERE program_id = '$program_id'");

        header("location:../registrar_manage_program.php?department&department_id=$department_id&program_id=$program_id&deactivated");
    }
