...
if(isset($_POST['academic_id'])){
    ...
    $user_action = 'Restored academic year <b>'.$academic_year_from.' - '.$academic_year_to.' '.'('.$academic_term.')</b>';
    ...
    header("location:../admin_academic.php?restored&academic_id=$academic_id");
}
