...
$user_action   = 'Hid an announcement';
...
mysqli_query($con, "UPDATE announcements SET announcement_status = 0 WHERE announcement_id = '$announcement_id'");

header("location:../admin_announcements.php?hidden");
