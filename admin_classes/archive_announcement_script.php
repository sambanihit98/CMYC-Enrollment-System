...
$user_action   = 'Archived an announcement';
...
mysqli_query($con, "UPDATE announcements SET announcement_status = 2 WHERE announcement_id = '$announcement_id'");

header("location:../admin_announcements.php?archived");
