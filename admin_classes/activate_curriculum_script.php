...
if(isset($_POST['curriculum_id'])){
    ...
    $user_action      = 'Activated <b>'.$curriculum.'</b> curriculum';
    ...
    while($row = mysqli_fetch_array($query)){
        ...
        mysqli_query($con, "UPDATE manage_curriculum SET curriculum_status = 1 WHERE curriculum_id = '$curriculum_id'");

        mysqli_query($con, "UPDATE manage_curriculum SET curriculum_status = 0 WHERE program_id = '$program_id' 
                            AND curriculum_id != '$curriculum_id'");

        header("location:../registrar_manage_curriculum.php?department&department_id=$department_id&curriculum=$curriculum&activated");
    }
