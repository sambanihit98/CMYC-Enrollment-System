...
if(isset($_POST['save_btn'])){
  ...
  $zero             = 0;  
  $user_action      = 'Enrolled <b>'.$fullname.' (Shiftee)</b> in <b>'.$section.'</b> for the academic year <b>'.$academic_year.'</b>';
  ...
  //---------------------------------------------------------------------------------------------------------
    ...
    if (mysqli_num_rows($query1)>0){
      header("location:../reg_manage_enrollment_shiftee.php?duplicate");
      ...
      header("location:../registrar_manage_enrollment.php?shiftee_added");
