...
if(isset($_POST['department_id'])){
    ...
    $user_action      = 'Restored <b>'.$department_description.' '.'('.$department_code.')</b>'.' department';
    ...
    header("location:../registrar_manage_department.php?restored&department_id=$department_id");
}
