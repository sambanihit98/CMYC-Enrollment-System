<?php
    ...
    $student_name_extension     = $_POST['student_name_extension'];
    ...
    $zero             = 0;  
    $user_action      = 'Enrolled <b>'.$fullname.' (Old Student)</b> in <b>'.$section.'</b> for the academic year <b>'.$academic_year.'</b>';
