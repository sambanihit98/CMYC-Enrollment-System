...
if(isset($_POST['account_user_id'])){
  ...
  $user_action = 'Archived <b>'.$fullname.' ('.$account_position.')</b> account';
  ...
  $zero          = 0;
    ...
    mysqli_query($con, "UPDATE faculty_account SET account_status = 2 WHERE account_user_id = '$account_user_id'");

    header("location:../admin_designation.php?archived&name=$fullname&account_position=$account_position");
}
