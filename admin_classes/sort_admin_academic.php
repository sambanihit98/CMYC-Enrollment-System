...
if(isset($_POST['sort_year_asc'])){

	$response = '
		<table class="table table-striped" style = "margin-bottom:100px;">
			<thead class="bg-success text-center">
				<th> ACADEMIC YEAR <i class="fa fa-arrow-up ml-2" id = "sort_year_desc" > </td>                      
				<th> TERM </td>
				<th> STATUS </td>
				<th> ACTION </td>
			</thead>';
	...
	$query1 = mysqli_query($con, "SELECT * FROM academic_year ORDER BY academic_year_from ASC, academic_term ASC");
