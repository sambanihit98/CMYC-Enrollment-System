<?php
  ...
  if(isset($_POST['next_btn'])){
    ...
    $curriculum_id      = $_POST['select_curriculum'];
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="ibox ">
                  ...
                  <!---------------------------------------------------------------------------------------------------------------------------->
                  <!---------------------------------------------------------------------------------------------------------------------------->
                  <form action = "admin_classes/insert_transferee_enrollment.php" method = "POST">

                    <!---------------------------------------------------------------------------------------------------------------------------->
                    <!---------------------------------------------------------------------------------------------------------------------------->
                    <!--HIDDEN DATA---->
                    <input type = 'text' value = '<?php echo $faculty_user_id; ?>'     name = 'faculty_user_id'    hidden>
                    <input type = 'text' value = '<?php echo $student_id; ?>'          name = 'student_id'         hidden>
                    <input type = 'text' value = '<?php echo $academic_id; ?>'         name = 'academic_id'        hidden>

                    <input type = 'text' value = '<?php echo $department_id; ?>'       name = 'department_id'      hidden>
                    <input type = 'text' value = '<?php echo $program_id; ?>'          name = 'program_id'         hidden>
                    <input type = 'text' value = '<?php echo $curriculum_id; ?>'       name = 'curriculum_id'      hidden>
                    <input type = 'text' value = '<?php echo $student_status; ?>'      name = 'student_status'     hidden>
                    <input type = 'text' value = '<?php echo $student_year_level; ?>'  name = 'student_year_level' hidden>
                    <input type = 'text' value = '<?php echo $student_semester; ?>'    name = 'student_semester'   hidden>
                    <input type = 'text' value = '<?php echo $student_section; ?>'     name = 'student_section'    hidden>
                    ...
                    <input type = 'text' value = '<?php echo $middlename; ?>'          name = 'middlename'         hidden>
                    <input type = 'text' value = '<?php echo $name_extension; ?>'      name = 'name_extension'     hidden>

                    <input type = 'text' value = '<?php echo $address; ?>'             name = 'address'            hidden>

                    <input type = 'text' value = '<?php echo $birthdate; ?>'           name = 'birthdate'          hidden>
                    <input type = 'text' value = '<?php echo $birthplace; ?>'          name = 'birthplace'         hidden>
                    <input type = 'text' value = '<?php echo $gender; ?>'              name = 'gender'             hidden>
                    <input type = 'text' value = '<?php echo $civil_status; ?>'        name = 'civil_status'       hidden>

                    <input type = 'text' value = '<?php echo $citizenship; ?>'         name = 'citizenship'        hidden>
                    <input type = 'text' value = '<?php echo $religion; ?>'            name = 'religion'           hidden>
                    <input type = 'text' value = '<?php echo $phone_number; ?>'        name = 'phone_number'       hidden>
